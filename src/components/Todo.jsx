...
const Todo = () => {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-green-100 via-teal-100 to-blue-100 py-12 px-4">
            {/* Toast Container with better config */}
            <ToastContainer
                position="top-right"
                autoClose={3000}
            ...
            <div className="max-w-2xl mx-auto bg-white rounded-3xl shadow-2xl p-10">
                ...
                <div className="space-y-5">
                    ...
                    {inputData.map((item) => (
                        <div
                            key={item.id}
                            className={`flex items-center justify-between bg-gradient-to-r from-white via-teal-50 to-green-50 p-5 rounded-xl shadow-md transition-all duration-200 ${item.completed ? "opacity-70" : ""
                                }`}
                        >
                            <div className="flex items-center gap-4">
                                ...
                                <span
                                    className={`text-lg font-medium ${item.completed
                            ...
                            <div className="flex items-center gap-3">
                                <span
                                    className={`px-3 py-1 rounded-full text-xs font-semibold ${item.completed
